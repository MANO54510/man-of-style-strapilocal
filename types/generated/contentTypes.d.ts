...
export interface ApiParametressiteParametressite
  extends Struct.SingleTypeSchema {
  collectionName: 'parametressites';
  info: {
    displayName: 'parametressite';
    pluralName: 'parametressites';
    singularName: 'parametressite';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::parametressite.parametressite'
    > &
      Schema.Attribute.Private;
    logo: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
...
export interface ApiTemoignageTemoignage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    nomClient: Schema.Attribute.String & Schema.Attribute.Required;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::parametressite.parametressite': ApiParametressiteParametressite;
